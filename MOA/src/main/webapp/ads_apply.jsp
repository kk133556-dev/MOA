...
<script>
    ...
    document.querySelectorAll('.tpl-chip').forEach(bindTplChip);

    document.getElementById('tplAddNewBtn').addEventListener('click', function () {
        ...
        fetch('QuickAdTemplateServlet', { method: 'POST', body: params })
            ...
            .then(function (data) {
                ...
                tplList.insertBefore(chip, document.getElementById('tplAddNewBtn'));
                bindTplChip(chip);
            });
    });
</script>
